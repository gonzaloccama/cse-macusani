...

{
	...
	public $v_fields = array('dni', 'nombres', 'ape_pat', 'ape_mat', 'fech_naci', 'sexo.sexo', 'nucleo_fam.nucleo_fam', 'celular', 'observations', 'fecha_registro', 'no_ficha');
	...
	function getList($table, $pagination = array())
	{
		...
		$this->db->select("$table.*  , sexo.sexo as sexo  , nucleo_fam.nucleo_fam as nucleo_fam ");
