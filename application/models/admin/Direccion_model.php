...
{
    public $v_fields=array('direccion', 'barrio.barrio', 'ciudad.ciudad', 'fecha_registro', 'hogar.no_ficha');
	...
	function getList($table, $pagination=array()) {
        ...
        $this->db->select("$table.*  , barrio.barrio as barrio  , ciudad.ciudad as ciudad  , hogar.no_ficha as no_ficha ");
        $this->db->from($table);
         $this->db->join("barrio", "direccion.barrio = barrio.id_barrio", "left");  $this->db->join("ciudad", "direccion.ciudad = ciudad.id_ciudad", "left");  $this->db->join("hogar", "direccion.no_ficha = hogar.no_ficha", "left");     
    ...
    function getRow($table, $id) {
        $this->db->select('*');
        $query = $this->db->get_where($table, array('id_direccion' => $id));
        $data = $query->result();
        return $data[0];
    }
