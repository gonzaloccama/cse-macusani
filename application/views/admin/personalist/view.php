								...
								<table class='table table-bordered' style='width:70%;' align='center'>
									...
									<tr>
										...
										<td>
											...
											<label for="dni" class="col-sm-5 control-label"> DNI </label>
									...
									<tr>
										...
										<td>
											...
											<label for="ape_pat" class="col-sm-5 control-label"> Apellido paterno </label>
									...
									<tr>
										...
										<td>
											...
											<label for="ape_mat" class="col-sm-5 control-label"> Apellido materno </label>
									...
									<tr>
										...
										<td>
											...
											<label for="fech_naci" class="col-sm-5 control-label"> Fecha de nacimiento </label>
									...
									<tr>
										...
										<td>
											...
											<label class="control-label col-md-5"> Nucleo familiar </label>
									...
									<tr>
										...
										<td>
											...
											<label for="observations" class="col-sm-5 control-label">
												Observaciones </label>
									...
									<tr>
										...
										<td>
											...
											<label for="fecha_registro" class="col-sm-5 control-label">
									...
									<tr>
										...
										<td>
											...
											<label class="control-label col-md-5"> No de ficha </label>
										...
										<td>
											...
											if (isset($hogar) && !empty($hogar)):
												...
												foreach ($hogar as $key => $value):
													...
													if ($value->no_ficha == $persona->no_ficha)
									...
									<tr>
										<td colspan="2"><a type="reset" class="btn btn-success pull-right"
