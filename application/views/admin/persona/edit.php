	...
	<div class="wrapper wrapper-content animated fadeInRight">
		...
		<div class="ibox ">
			...
			<div class="ibox-title">
				...
				<h5> Editar persona <small></small></h5>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<input type="text" disabled class="form-control" id="dni"
										   ...
										   value="<?php echo set_value("dni", html_entity_decode($persona->dni)); ?>"
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<input type="text" class="form-control" id="nombres" name="nombres"
										   ...
										   value="<?php echo set_value("nombres", html_entity_decode($persona->nombres)); ?>"
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<input type="text" class="form-control" id="ape_pat" name="ape_pat"
										   ...
										   value="<?php echo set_value("ape_pat", html_entity_decode($persona->ape_pat)); ?>"
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<input type="text" class="form-control" id="ape_mat" name="ape_mat"
										   ...
										   value="<?php echo set_value("ape_mat", html_entity_decode($persona->ape_mat)); ?>"
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<input type="text" class="form-control span2 datepicker" id="fech_naci"
										   ...
										   value="<?php echo set_value("fech_naci", $persona->fech_naci); ?>"
									...
									<select class="form-control select2" name="sexo" id="sexo">
										...
										if (isset($sexo) && !empty($sexo)):
											...
											foreach ($sexo as $key => $value): ?>
												...
												<option
													value="<?php echo $value->id_sexo; ?>" <?php echo $value->id_sexo == $persona->sexo ? 'selected="selected"' : ""; ?>>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									...
									<select class="form-control select2" name="nucleo_fam" id="nucleo_fam">
										...
										<option value="">Select Nucleo_fam</option>
										...
										if (isset($nucleo_fam) && !empty($nucleo_fam)):
											...
											foreach ($nucleo_fam as $key => $value): ?>
												...
												<option
													value="<?php echo $value->id_nucleofam; ?>" <?php echo $value->id_nucleofam == $persona->nucleo_fam ? 'selected="selected"' : ""; ?>>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<input type="text" class="form-control" id="celular" name="celular"
										   ...
										   value="<?php echo set_value("celular", html_entity_decode($persona->celular)); ?>"
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<textarea class="form-control" id="observations"
											  name="observations"><?php echo set_value("observations", html_entity_decode($persona->observations)); ?></textarea>
...
<!--								<div class="col-sm-4">-->
									...
									<input type="hidden" class="form-control span2 datepicker" id="fecha_registro"
										   ...
										   value="<?php echo set_value("fecha_registro", $persona->fecha_registro); ?>"
...
<!--							</div>-->
							...
							<div class="form-group">
								...
								<label class="control-label col-md-3"> Número de ficha </label>

								<div class="col-md-4">

									<select class="form-control select2" name="no_ficha" id="no_ficha">

										<option value="">Seleccionar Número de ficha</option>
										...
										if (isset($hogar) && !empty($hogar)):
											...
											foreach ($hogar as $key => $value): ?>
												...
												<option
													value="<?php echo $value->no_ficha; ?>" <?php echo $value->no_ficha == $persona->no_ficha ? 'selected="selected"' : ""; ?>>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									...
									<input type="hidden" name="rel_field" id="rel_field"
										   value="<?php echo $rel_field; ?>">
